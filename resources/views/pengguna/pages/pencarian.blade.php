          ...
          <div class="col-md-12 mb-5">
            <div class="float-md-left mb-4">
              <h2 class="text-black h5">
                ...
                !!}
                @else
                Hasil Pencarian Produk {!! !empty($_GET['search']) ? ' <span
                  class="text-primary">"'.$_GET['search'].'"</span>': false !!}
                @endif
              </h2>
            </div>
          </div>
        ...
        <div class="row mb-5">
          ...
          <div class="col-sm-6 col-lg-4 mb-4" data-aos="fade-up">
            <div class="block-4 text-center border">
              <figure class="block-4-image">
                <a href="{{ route('api_getDetailProduk', ['id' => $item->id]) }}">
                  <img src="{{$item->foto_barang}}" class="img-fluid product p-1 alt="">
                </a>
              </figure>
              <div class="block-4-text p-4">
                <h3><a href="{{ route('api_getDetailProduk', ['id' => $item->id]) }}">{{ $item->nama_barang }}</a>
                </h3>
                <hr>
          ...
          <div class="col-sm-12 col-lg-12 mb-4" data-aos="fade">
            <div class="block-4 text-center border-0">
              <div class="block-4-text p-4">
                <h3><span class="icon-shopping-bag display-3"></span> <span class="display-3">Tidak Ditemukan</span>
                </h3>
              </div>
            </div>
          </div>
      ...
      <div class="col-md-3 order-1 mb-5 mb-md-0">
        <div class="border p-4 rounded mb-4">
          ...
          <ul class="list-unstyled mb-0">
            ...
            <li class="mb-1">
              <a href="{{ route('api_getPencarianProduk') }}/?kategori={{ strtolower(str_replace(' ', '-', $item['nama_kategori'])) }}"
                class="d-flex">
